...
TARGET = assembler
OBJS = assembler.o asm_state.o pass1.o line_reader.o parser.o pass1_directives.o symbols.o ops.o operand.o pass1_instructions.o code_image.o encoder.o data_image.o errors.o mcro.o handle_files.o preassembler_parser.o preassembler.o fixups.o pass2.o output_files.o
...
pass2.o: pass2.c pass2.h defs.h asm_state.h handle_files.h line_reader.h parser.h symbols.h fixups.h code_image.h word.h ops.h errors.h output_files.h
	$(CC) $(CFLAGS) -c pass2.c

output_files.o : output_files.c output_files.h asm_state.h handle_files.h symbols.h defs.h
